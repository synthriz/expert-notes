  ...
  return (
    <button className="rounded-md text-left bg-slate-800 p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
      ...
      <p className="text-sm leading-6 text-slate-400">
        ...
        omnis magnam consequuntur commodi quas culpa aut distinctio quibusdam
        architecto enim cumque totam hic, voluptas dolor minus excepturi
        quaerat. Fuga. Lorem ipsum dolor sit amet consectetur adipisicing elit.
        Nemo inventore omnis magnam consequuntur commodi quas culpa aut
        distinctio quibusdam architecto enim cumque totam hic, voluptas dolor
        minus excepturi quaerat. Fuga.
      </p>
